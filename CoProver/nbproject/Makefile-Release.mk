...
${OBJECTDIR}/Alg/Resolution.o: Alg/Resolution.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Alg/Resolution.o Alg/Resolution.cpp

${OBJECTDIR}/Alg/TriAlg.o: Alg/TriAlg.cpp
	${MKDIR} -p ${OBJECTDIR}/Alg
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Alg/TriAlg.o Alg/TriAlg.cpp

${OBJECTDIR}/Alg/TriAlgExt.o: Alg/TriAlgExt.cpp
	${MKDIR} -p ${OBJECTDIR}/Alg
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Alg/TriAlgExt.o Alg/TriAlgExt.cpp

${OBJECTDIR}/CLAUSE/Clause.o: CLAUSE/Clause.cpp
	${MKDIR} -p ${OBJECTDIR}/CLAUSE
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CLAUSE/Clause.o CLAUSE/Clause.cpp

${OBJECTDIR}/CLAUSE/Literal.o: CLAUSE/Literal.cpp
	${MKDIR} -p ${OBJECTDIR}/CLAUSE
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CLAUSE/Literal.o CLAUSE/Literal.cpp

${OBJECTDIR}/Formula/ClauseSet.o: Formula/ClauseSet.cpp
	${MKDIR} -p ${OBJECTDIR}/Formula
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Formula/ClauseSet.o Formula/ClauseSet.cpp

${OBJECTDIR}/Formula/Formula.o: Formula/Formula.cpp
	${MKDIR} -p ${OBJECTDIR}/Formula
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Formula/Formula.o Formula/Formula.cpp

${OBJECTDIR}/Formula/FormulaSet.o: Formula/FormulaSet.cpp
	${MKDIR} -p ${OBJECTDIR}/Formula
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Formula/FormulaSet.o Formula/FormulaSet.cpp

${OBJECTDIR}/Formula/WFormula.o: Formula/WFormula.cpp
	${MKDIR} -p ${OBJECTDIR}/Formula
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Formula/WFormula.o Formula/WFormula.cpp

${OBJECTDIR}/Global/Environment.o: Global/Environment.cpp
	${MKDIR} -p ${OBJECTDIR}/Global
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Global/Environment.o Global/Environment.cpp
...
${OBJECTDIR}/Global/SysDate.o: Global/SysDate.cpp
	${MKDIR} -p ${OBJECTDIR}/Global
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Global/SysDate.o Global/SysDate.cpp

${OBJECTDIR}/HEURISTICS/Options.o: HEURISTICS/Options.cpp
	${MKDIR} -p ${OBJECTDIR}/HEURISTICS
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HEURISTICS/Options.o HEURISTICS/Options.cpp

${OBJECTDIR}/HEURISTICS/SortRule.o: HEURISTICS/SortRule.cpp
	${MKDIR} -p ${OBJECTDIR}/HEURISTICS
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HEURISTICS/SortRule.o HEURISTICS/SortRule.cpp

${OBJECTDIR}/HEURISTICS/StrategyParam.o: HEURISTICS/StrategyParam.cpp
	${MKDIR} -p ${OBJECTDIR}/HEURISTICS
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HEURISTICS/StrategyParam.o HEURISTICS/StrategyParam.cpp

${OBJECTDIR}/INOUT/CommandLine.o: INOUT/CommandLine.cpp
	${MKDIR} -p ${OBJECTDIR}/INOUT
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INOUT/CommandLine.o INOUT/CommandLine.cpp

${OBJECTDIR}/INOUT/FileOp.o: INOUT/FileOp.cpp
	${MKDIR} -p ${OBJECTDIR}/INOUT
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INOUT/FileOp.o INOUT/FileOp.cpp

${OBJECTDIR}/INOUT/Scanner.o: INOUT/Scanner.cpp
	${MKDIR} -p ${OBJECTDIR}/INOUT
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INOUT/Scanner.o INOUT/Scanner.cpp

${OBJECTDIR}/INOUT/StreamCell.o: INOUT/StreamCell.cpp
	${MKDIR} -p ${OBJECTDIR}/INOUT
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INOUT/StreamCell.o INOUT/StreamCell.cpp

${OBJECTDIR}/INOUT/TokenCell.o: INOUT/TokenCell.cpp
	${MKDIR} -p ${OBJECTDIR}/INOUT
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INOUT/TokenCell.o INOUT/TokenCell.cpp

${OBJECTDIR}/Indexing/TermIndexing.o: Indexing/TermIndexing.cpp
	${MKDIR} -p ${OBJECTDIR}/Indexing
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Indexing/TermIndexing.o Indexing/TermIndexing.cpp

${OBJECTDIR}/Inferences/InferenceInfo.o: Inferences/InferenceInfo.cpp
	${MKDIR} -p ${OBJECTDIR}/Inferences
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inferences/InferenceInfo.o Inferences/InferenceInfo.cpp

${OBJECTDIR}/Inferences/Simplification.o: Inferences/Simplification.cpp
	${MKDIR} -p ${OBJECTDIR}/Inferences
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inferences/Simplification.o Inferences/Simplification.cpp

${OBJECTDIR}/Inferences/Subst.o: Inferences/Subst.cpp
	${MKDIR} -p ${OBJECTDIR}/Inferences
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inferences/Subst.o Inferences/Subst.cpp

${OBJECTDIR}/Inferences/Unify.o: Inferences/Unify.cpp
	${MKDIR} -p ${OBJECTDIR}/Inferences
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inferences/Unify.o Inferences/Unify.cpp

${OBJECTDIR}/LIB/Out.o: LIB/Out.cpp
	${MKDIR} -p ${OBJECTDIR}/LIB
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LIB/Out.o LIB/Out.cpp

${OBJECTDIR}/Orderings/KBO.o: Orderings/KBO.cpp
	${MKDIR} -p ${OBJECTDIR}/Orderings
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Orderings/KBO.o Orderings/KBO.cpp

${OBJECTDIR}/Orderings/Ordering.o: Orderings/Ordering.cpp
	${MKDIR} -p ${OBJECTDIR}/Orderings
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Orderings/Ordering.o Orderings/Ordering.cpp

${OBJECTDIR}/PROOF/ProofControl.o: PROOF/ProofControl.cpp
	${MKDIR} -p ${OBJECTDIR}/PROOF
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PROOF/ProofControl.o PROOF/ProofControl.cpp

${OBJECTDIR}/PROOF/ProverResultAnalyse.o: PROOF/ProverResultAnalyse.cpp
	${MKDIR} -p ${OBJECTDIR}/PROOF
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PROOF/ProverResultAnalyse.o PROOF/ProverResultAnalyse.cpp

${OBJECTDIR}/Prover/Prover.o: Prover/Prover.cpp
	${MKDIR} -p ${OBJECTDIR}/Prover
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prover/Prover.o Prover/Prover.cpp

${OBJECTDIR}/Terms/GroundTermBank.o: Terms/GroundTermBank.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/GroundTermBank.o Terms/GroundTermBank.cpp

${OBJECTDIR}/Terms/Sigcell.o: Terms/Sigcell.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/Sigcell.o Terms/Sigcell.cpp

${OBJECTDIR}/Terms/TermBank.o: Terms/TermBank.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/TermBank.o Terms/TermBank.cpp

${OBJECTDIR}/Terms/TermCell.o: Terms/TermCell.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/TermCell.o Terms/TermCell.cpp

${OBJECTDIR}/Terms/TermCellStore.o: Terms/TermCellStore.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/TermCellStore.o Terms/TermCellStore.cpp

${OBJECTDIR}/Terms/TermTree.o: Terms/TermTree.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/TermTree.o Terms/TermTree.cpp

${OBJECTDIR}/Terms/VarBank.o: Terms/VarBank.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/VarBank.o Terms/VarBank.cpp

${OBJECTDIR}/Terms/VarHash.o: Terms/VarHash.cpp
	${MKDIR} -p ${OBJECTDIR}/Terms
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Terms/VarHash.o Terms/VarHash.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
